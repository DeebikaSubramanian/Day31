...
let formik = useFormik({
  initialValues: {
    ...
    return errors;
      ...
      onSubmit: async(values) => {
        await axios.put(`https://624357603da3ac772b01a9e9.mockapi.io/student/${params.id}`,values);
        navigate('/student')
  ...
  {
    try{
      const student=await axios.get(`https://624357603da3ac772b01a9e9.mockapi.io/student/${params.id}`)
